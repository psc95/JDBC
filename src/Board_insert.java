...
public class Board_insert {
	public static void main(String[] args) {
		...
		try {
			...
			con = DriverManager.getConnection(url, user, password);//오라클 연결주소=DB접속주소,사용자,비번을 메서드
			//인자값으로 전달해서 데이터 베이스 연결 con생성
			...
			stmt = con.createStatement();//쿼리문 수행할 stmt생성
